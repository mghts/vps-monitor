...
const english: Record<string, string> = {
  ...
  '调整筛选条件，或在管理后台添加节点。': 'Adjust filters or add a node in the admin panel.',
  '名称': 'Name',
  '状态': 'Status',
  '内存': 'Memory',
  '磁盘': 'Disk',
  ...
  '接入服务器并配置 Ping 目标后，这里会显示延迟和丢包曲线。': 'Latency and packet-loss charts appear after targets are configured.',
  '延迟 ms': 'Latency ms',
  '丢包率 %': 'Loss %',
